-- From https://github.com/GoogleCloudPlatform/professional-services/tree/master/examples/bigquery-audit-log
...
WITH BQAudit AS (
  ...
  FROM
    `bigquery_auditlog_dataset.cloudaudit_googleapis_com_data_access`
  WHERE
